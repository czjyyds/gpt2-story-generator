...
def find_vid(pic_path:str, dataset_path:str =  os.path.join(os.path.dirname(__file__), 'model'),
             resolution:(int, int) = (160, 120), topN:int = 5, pic_path_is_url:bool = False,
